...
And a third option, the official youtube plugin with modified request_client.py inside it - https://github.com/ReaLx3m/FLAM-Fixes/blob/main/plugin.video.youtube-7.4.4.zip
